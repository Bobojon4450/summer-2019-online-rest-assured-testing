...
public class ORDS_Tests {
    ...
    /* Address of ORDS web service, that is running on AWS ec2.
       that is coming from SQL Oracle data base to this web service
       during back-end testing with SQL developer and JDBC API
       we were accessing data base directly now, we gonna access web service  */
    ...
    public void test3() {
        ...
        System.out.println("LastHeader content type: "+header.toString());
    }
}
